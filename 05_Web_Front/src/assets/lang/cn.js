module.exports = {
    common: {
        ...
        testText1: '这是一个测试站！购买商用系统请联系 技术Telegram:@Nashcoin ',
        testText2: '@Nashcoin  ',
    ...
    sectionPage: {
        ...
        brandDesc2: "WWW.BIZZAN.BIZ定位于区块链基础服务商，致力于为全球用户提供优质加密资产交易平台，秉承着“不作恶”的基本原则，坚持诚实、公正、热情的服务于客户，以开放的态度迎接一切有利于用户根本利益的伙伴/项目。为现实资产代币化打下了坚实的基础，并为现实资产代币化提供了喂价机制和价格发现的支持；NASH致力于成为全球首例成功将现实资产领域与加密资产领域完全打通、深度融合、平衡发展的不可或缺的项目。",
