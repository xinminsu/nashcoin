module.exports = {
    common: {
        ...
        testText1: '这是一个测试站！购买商用系统请联系 技术Telegram: ',
        testText2: '@Nashcoin  ',
        testText3: '（点击@跳转 唯一渠道，谨防被骗）',
        chonggou:  ''
    },
    header: {
        index: '首页',
    ...
    sectionPage: {
        ...
        brandDesc1: "NASH专注于：RWA与数字资产合约及现货交易，结合区块链、智能合约、数字加密技术，建设标准化   的现实资产映射上链铸造NFT的验证体系和交易机制，打破了跨市场跨领域的技术壁垒、信用壁垒、标准化壁垒，提高了多市场流通性、创建了全新的交易机制和结算方式；",
        brandDesc2: "为现实资产代币化打下了坚实的基础，并为现实资产代币化提供了喂价机制和价格发现的支持；NASH致力于成为全球首例成功将现实资产领域与加密资产领域完全打通、深度融合、平衡发展的不可或缺的项目。",
        gettingstart: "新手入门 | 极速买币",
        officialstart: "NASH官方新手入门辅助通道",
        oneminutebuy: "币币交易",
    ...
    activity: {
        ...
        attentiontxt4: "* 本活动最终解释权归NASH(WWW.NASH.BIZ)官方所有",
        inputamount: "输入兑换数量",
        ...
        submit: "提交",
        tipsmobile: "请进入电脑端页面参与（WWW.NASH.BIZ）",
        tipsmobile1: "请在电脑端打开（WWW.NASH.BIZ）并进入创新实验区参与",
        intvalue: "请输入整数",
    ...
    invite: {
        ...
        partnerlevel: "合伙级别",
        ruledetail: "规则详情",
        ruleprofile1:"NASH(WWW.NASH.BIZ)的【推广合伙人】是全网",
        ruleprofile2:"返佣比例最高、",
        ruleprofile3:"返佣时长最长(最高终身返佣)",
        ruleprofile4:"的推广活动，让付出相应努力的推广者能够成为真正意义上的平台“合伙人”，享受与NASH(WWW.NASH.BIZ)交易平台共同成长的红利！具体细则如下：",
        ruletext1: "一、为布道数字资产理念与扩大用户规模，NASH(WWW.NASH.BIZ)推出【推广合伙人】计划，该活动长期有效。",
        ...
        thanks: "感谢您陪着NASH(WWW.NASH.BIZ)一起成长！",
        ...
        pt_card_rule2: "二、免费礼品卡每个用户限兑1份。由NASH(WWW.NASH.BIZ)官方发放的免费礼品卡，每个用户限兑一份，即使通过不同用户领取到不同兑换码的免费礼品卡，也只能兑换1份。自定义制作礼品卡不受此限制。",
        ...
        pt_card_rule6: "六、免费礼品卡最终解释权归WWW.NASH.BIZ所有。",
        pt_card_day: "天",
    ...
    cms: {
        ...
        scanforshare: "扫一扫分享",
        download: "立即下载",
        downloadslogan: "NASHAPP - 全球数字资产交易平台"
    },
    description: {
        ...
        message5: 'NASH(WWW.NASH.BIZ)国际数字加密资产交易平台手机客户端，专注掌上交易体验',
        scanqrcode: "扫描二维码，下载APP",
        aboutdesc1: "NASH(WWW.NASH.BIZ)是技术全球领先的数字资产交易平台，注册于开曼群岛，核心运营团队位于香港。NASH(WWW.NASH.BIZ)核心成员来自于顶级互联网和金融公司，大部分成员是深度比特币和区块链信仰者，我们深信区块链将改变传统垄断性金融体系，会建立一个更加民主、自治的社会结构。",
        aboutdesc2: "NASH(WWW.NASH.BIZ)平台拥有专业金融级别的交易架构，拥有自主研发的高并发内存撮合交易引擎，平台采用全冷充值钱包系统+多重签名+高防护DDOS攻击系统等交易架构，保证客户资产安全。",
        aboutdesc3: "NASH(WWW.NASH.BIZ)为了让客户更好的把握投资机会，客服部门内部采用扁平化管理，建立了极速服务响应机制，资产客服经理常年7*24H在线，为客户提供资产充值提现等服务，保障客户在25分钟内完成资产充提。",
        aboutdesc4: "NASH(WWW.NASH.BIZ)严格筛选优质项目并提供安全稳定的资产托管服务。NASH(WWW.NASH.BIZ)秉承着“诚实、公正、热情、开放”的理念，竭力为用户打造安全、可靠、高效和友好的极致交易所。",
    ...
    bzb_description: {
        ...
        desc4: "参与NASH社区投票活动，包括但不限于上币、回购等",
    ...
    index: {
        ...
        BHBregister: "NASH账户注册",
        tibi: "提币到账时间及限额",
        line_plane: "BHB上线计划、流通量及手续费返还公告",
        fenpeijizhi: '关于NASH收入分配机制的说明',
        jiangli_jihua: "邀请挖矿奖励计划",
        friend_fanhuan: "邀请好友、赚取额外手续费返还"
    },
    plate: {
        title: "平台收入分配方案 (BHB 持有者权益)",
        content1: "正如白皮书所描述的，NASH会拿出平台的80% (扣除税费后) 的收入分配给NASH持有者，20%的收入用来支持平台的研发及运营。",
