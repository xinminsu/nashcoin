module.exports = {
    common: {
        ...
        set: 'Set',
        update: 'Modify',
        slogan: "Experience the world’s top digital currency trade",
        subslogan: "Trade Boundlessly",
        more: "More",
        please: "Please",
        nodata: "No Records",
        pleaseselect: "Select",
    ...
    sectionPage: {
        ...
        brandTitle: "About NASH",
        brandDetail: "Honest  |  Fair  |  Enthusiasm  |  Open",
        brandDesc1: "NASH focuses on Real World Assets (RWA), digital asset contracts, and spot trading. By integrating blockchain, smart contracts, and digital encryption technologies, it establishes a standardized system for mapping real assets onto the blockchain and minting NFTs. This breaks down technical, credit, and standardization barriers across markets and industries, enhances multi-market liquidity, and creates new trading mechanisms and settlement methods.",
        brandDesc2: "NASH lays a solid foundation for the tokenization of real assets and supports price feeds and price discovery mechanisms for these tokenized assets.NASH is committed to becoming the world’s first indispensable project that fully connects, deeply integrates, and balances the development of real assets and crypto assets.",
        gettingstart: "HOT | Beginner's Guide",
        officialstart: "NASH Official Customer Service",
    ...
    ctc: {
        ...
        desc:"Crypto assets are managed by NASH, and the acceptor provides exchange services for exchange.",
        buyin: "Buy",
        sell: "Sell",
        buyprice: "Buy Price",
        sellprice: "Sell Price",
    ...
    activity: {
        ...
        attentiontxt4: "* The right of final interpretation of this activity belongs to the official ownership of NASH.",
    ...
    invite: {
        ...
        ruleprofile1:"[Promotion Partner] is the highest proportion of online Commission return and the longest time of commission return (maximum lifetime commission). Promoters who make corresponding efforts can become real platform ‘partners’ and enjoy the dividend of growing together with NASH trading platform. Detailed rules are as follows:",
        ruleprofile2:"",
        ruleprofile3:"",
        ruleprofile4:"",
        ruletext1: "1、In order to preach the concept of digital assets and expand the scale of users, NASH launched the “Promotion Partner” program, which is effective for a long time.",
        ...
        ruletext8: "8、TOP10 or TOP100 will be awarded additional incentives by NASH from time to time.",
        ...
        ruletext11: "11、The right of final interpretation of this activity belongs to NASH.",
        ...
        thanks: "Thank you for supporting NASH！",
        ...
        pt_card_rule6: "6. The right of final interpretation of free gift cards belongs to NASHEX.COM.",
        pt_card_day: "Days",
    ...
    uc: {
        ...
        identity: {
            ...
            become: "Become NASH Certified Business and enjoy more transaction privileges",
    ...
    cms: {
        ...
        download: "Download",
        downloadslogan: "NASH APP - Trade everywhere."
    },
    description: {
        title1: 'Security',
        title2: '24H Service',
        ...
        apply: "Board Apply",
        coop: "Cooperation",
        community: "NASH Community",
        wechat: "Wechat",
        addwechat: "Add 'NASH' as Wechat friends and then enter Wechat community",
        weibo: "Weibo",
        twitter: "Twitter",
        biyong: "Biyong",
        telegram: "Telegram",
    ...
    index: {
        ...
        BHBregister: "NASH account registration",
        ...
        fenpeijizhi: 'A description of the NASH income distribution mechanism',
    ...
    plate: {
        ...
        content1: "As described in the white paper, NASH will take up 80% of the platform (after deduct Taxes and fees )The income is allocated to BHB holders, and 20% of revenue is used to support R & D and operation of the platform.",
    ...
    earn:{
        ...
        labdetail: "NASH Earn ● One-stop investment solution",
