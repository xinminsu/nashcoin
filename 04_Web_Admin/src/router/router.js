...
let findSlideArr = [
    ...
    { id: 242, path: '/swap', icon: 'android-options', component: Main },
    ...
    { id: 243, path: 'trading', icon: 'document', component: resolve => { require(['@/views/swap/Trading.vue'], resolve) } },
    { id: 248, path: 'entrust', icon: 'document', component: resolve => { require(['@/views/swap/Entrust.vue'], resolve) } },
    { id: 250, path: 'position', icon: 'document', component: resolve => { require(['@/views/swap/Position.vue'], resolve) } },    
